...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<com.github.mikephil.charting.data.BarEntry> {
    ...
    public BarDataSet(java.util.List<com.github.mikephil.charting.data.BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    public com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.BarEntry> copy() {
        ...
        java.util.List<com.github.mikephil.charting.data.BarEntry> yVals = new java.util.ArrayList<com.github.mikephil.charting.data.BarEntry>();
     ...
     */
    private void calcEntryCountIncludingStacks(java.util.List<com.github.mikephil.charting.data.BarEntry> yVals) {
